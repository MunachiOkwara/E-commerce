...
const Footer = ()=>{
 ...
 <input type="email" placeholder="  Enter- Email- Address" value={createlist} style={{height:'40px',border:'none',borderRadius:'5% 0 0 5%'}} onChange={(e)=> setCreateList(e.target.value)} />
  <button onClick={Update} style={{height:'40px', width:'90px',border:'none',background:'#FFD0BC',borderRadius:'0 5% 5% 0',cursor:'pointer', fontSize:'15px',fontFamily:'monospace'}}>Search</button>
  </div>
  </div>
  <div className="low">
          ...
          <div className="loww">
          <button style={{height: "30px",width:"100px",background:"rgb(6, 9, 48)",color:"white",border:"1px solid white",borderRadius:"5px", cursor:'pointer'}}>App Store</button> <button style={{height: "30px",width:"100px",background:"rgb(6, 9, 48)",color:"white",border:"1px solid white",borderRadius:"5px", cursor:"pointer"}}>Google Play</button>
          </div>
